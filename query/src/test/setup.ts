import { QueryEntity } from '../query/domain/query.entity';
import { QueryRepository } from '../query/domain/query.repository';
import { DynamoDB } from '../query/infrastructure/db/dynamo-db';

jest.setTimeout(100000);
//todo: delete all data by table after tests.

export class DynamoRepositoryError implements QueryRepository {
