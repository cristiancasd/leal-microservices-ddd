  ...
  return (
          ...
          <Box sx={{ flexGrow: 0, display: 'flex'}}>
            ...
            >
                ...
                <Typography variant="button" display="block" gutterBottom sx={{ p: 1 }}>Name: {user.name}</Typography>
                <Divider  /> 
                <Typography variant="button" display="block" gutterBottom sx={{ p: 1 }}>CC: {user.documentCc}</Typography>
                <Divider  /> 
